    ...
    return (
        <>
            ...
            <div className=" flex flex-col md:flex-row justify-between pt-20 bg-slate-100">
                <div className="bg-white hidden w-80 lg:w-96 h-custom3 mt-6 ml-6 rounded-lg p-6 z-50 md:flex flex-col items-center">
                    ...
                    <div className=" flex flex-col items-center mt-4 w-full">
                        ...
                        <div className="flex justify-between w-full mt-4">
                            <h1 className="font-poppins text-lg font-bold">Cards</h1>
                            <h1 className="font-poppins text-lg font-bold text-main">+ Add</h1>
                        </div>
                        <div className="flex flex-col w-full bg-main shadow-lg shadow-main/50 h-20 rounded-xl p-4 mt-2">
                            <h1 className="text-xs lg:text-base text-white font-poppins font-semibold tracking-widest">4441 1235 5512 5551</h1>
                            <div className="flex w-full justify-between mt-1">
                                <h1 className="text-blue-300 font-poppins font-medium text-sm">X Card</h1>
                                <h1 className="text-blue-300 font-poppins font-medium text-sm">$ 1,440.2</h1>
                            </div>
                        </div>
                        <div className="w-full mt-5">
                            <div className="flex justify-between  items-center" onClick={() => handleTabClick("MyProfile")}>
                                <div className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                        <path
                                            ...
                                            fill={`${activeTab === "MyProfile" ? "#2395FF" : "#979797"}`}
                                            stroke={`${activeTab === "MyProfile" ? "#2395FF" : "#979797"}`}
                                            stroke-width="4"
                                        />
                                    </svg>
                                    <h1 className={`font-poppins font-semibold text-black text-lg ml-3 cursor-pointer  ${activeTab === "MyProfile" ? "text-main" : "text-abu"}`}>Profile</h1>
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 10 18" fill="none">
                                    <path d="M1.07107 1.99998L7.43503 8.36394C7.82555 8.75446 7.82555 9.38763 7.43503 9.77815L1.07107 16.1421" stroke={`${activeTab === "MyProfile" ? "#2395FF" : "#979797"}`} strokeWidth="3" />
                                </svg>
                            </div>
                        </div>
                        <div className="w-full mt-5">
                            <div className="flex justify-between  items-center" onClick={() => handleTabClick("MyBooking")}>
                                <div className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 20 20" fill="none">
                                        <path
                                            d="M16.8243 3.33398H3.33268C2.41602 3.33398 1.67435 4.08398 1.67435 5.00065V8.33398C2.59102 8.33398 3.33268 9.08398 3.33268 10.0007C3.33268 10.9173 2.59102 11.6673 1.66602 11.6673V15.0007C1.66602 15.9173 2.41602 16.6673 3.33268 16.6673H16.666C17.5827 16.6673 18.3327 15.9173 18.3327 15.0007V5.00065C18.3327 4.08398 17.6577 3.33398 16.8243 3.33398ZM14.7743 11.084L7.39102 13.0507L6.00768 10.6507L6.78268 10.4423L7.83268 11.2673L9.82435 10.734L7.82435 7.26732L8.99102 6.95065L12.3327 10.0673L14.366 9.52565C14.5715 9.47131 14.7902 9.50038 14.9744 9.60651C15.1585 9.71265 15.2933 9.88726 15.3493 10.0923C15.4012 10.2999 15.3701 10.5195 15.2628 10.7047C15.1554 10.8898 14.9803 11.0258 14.7743 11.084Z"
                                            fill={`${activeTab === "MyBooking" ? "#2395FF" : "#979797"}`}
                                        />
                                    </svg>
                                    <h1 className={`font-poppins font-semibold text-black text-lg ml-3 cursor-pointer ${activeTab === "MyBooking" ? "text-main " : "text-abu"}`}>My Booking</h1>
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 10 18" fill="none">
                                    <path d="M1.07107 1.99998L7.43503 8.36394C7.82555 8.75446 7.82555 9.38763 7.43503 9.77815L1.07107 16.1421" stroke={`${activeTab === "MyBooking" ? "#2395FF" : "#979797"}`} strokeWidth="3" />
                                </svg>
                            </div>
                        </div>
                        <div className="w-full mt-5">
                ...
                <div className=" w-full mt-4 md:mt-2 px-6">
                    <div className="flex md:hidden flex-col justify-center items-center gap-2 lg:hidden">
                        ...
                        <div className="mt-6 flex flex-col justify-center">
                            ...
                            <div className="flex mt-2 justify-center">
                                ...
                                <h1 className="text-gray-500 font-medium font-poppins ">Cianjur, Indonesia</h1>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col w-full bg-main shadow-lg shadow-main/50 h-20 rounded-xl p-4">
                            <h1 className="text-lg text-white font-poppins font-semibold tracking-widest">4441 1235 5512 5551</h1>
                            <div className="flex w-full justify-between mt-1">
                                <h1 className="text-blue-300 font-poppins font-medium text-sm">X Card</h1>
                                <h1 className="text-blue-300 font-poppins font-medium text-sm">$ 1,440.2</h1>
                            </div>
                    ...
                    <div className="flex md:hidden gap-6 items-center font-poppins font-medium mt-8 justify-between px-5">
                        <h1 className={`flex justify-center gap-2 h-10 cursor-pointer w-1/2 ${activeTab === "MyProfile" ? "text-main border-b-4 border-b-main" : "text-abu"}`} onClick={() => handleTabClick("MyProfile")}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                <path
                                    d="M11.9557 19.8042L11.5647 17.8428C11.4589 17.8639 11.3521 17.8783 11.1703 17.9029C11.1449 17.9063 11.1181 17.9099 11.0896 17.9138L11.0836 17.9146C11.0338 17.9215 10.9884 17.9286 10.9521 17.9344L10.9015 17.9425L10.8609 17.949C10.8364 17.9529 10.8209 17.9552 10.8094 17.9568C10.8 17.9581 10.796 17.9585 10.796 17.9585L10.794 17.9587C10.5254 17.9851 10.2611 17.9992 9.99993 17.9992C9.73879 17.9992 9.47448 17.9851 9.20583 17.9587L9.20383 17.9585C9.20364 17.9585 9.20308 17.9585 9.20214 17.9583C9.20014 17.9581 9.19637 17.9576 9.19049 17.9568C9.17905 17.9553 9.16352 17.9529 9.13899 17.949L9.09839 17.9425L9.04775 17.9344C9.01143 17.9286 8.96597 17.9215 8.91618 17.9146L8.91026 17.9138C8.88169 17.9099 8.8548 17.9063 8.82937 17.9028C8.6476 17.8783 8.54091 17.8639 8.43519 17.8428L8.43519 17.8428L8.42555 17.8409C8.37956 17.832 8.35841 17.8264 8.31202 17.8141C8.27078 17.8032 8.20959 17.787 8.09323 17.7585C8.0374 17.7447 7.98986 17.7332 7.94828 17.7231C7.82955 17.6943 7.75947 17.6773 7.68392 17.6547C7.62449 17.6364 7.57975 17.6202 7.49318 17.5888C7.45252 17.574 7.40263 17.5559 7.33766 17.5327C7.25154 17.5018 7.19116 17.4808 7.14466 17.4646C7.06714 17.4377 7.02819 17.4241 6.97283 17.4009C6.87987 17.362 6.78797 17.3182 6.63898 17.2473L6.60922 17.2331L6.60574 17.2314C6.53867 17.1996 6.48827 17.1761 6.44757 17.1572C6.37257 17.1222 6.33051 17.1026 6.2778 17.0748C6.18048 17.0227 6.08267 16.9638 5.92804 16.8707L5.91125 16.8606C5.88989 16.8475 5.86914 16.8348 5.84891 16.8224C5.76212 16.7692 5.68487 16.7218 5.60914 16.6744C5.50383 16.6042 5.3933 16.5224 5.23374 16.4035L5.21382 16.3886L5.19354 16.3743C5.13929 16.3359 5.07778 16.2898 5.0114 16.2377C4.94893 16.1865 4.89065 16.1356 4.82233 16.0749L4.97358 15.3694C5.30408 13.8278 6.31921 12.5209 7.73114 11.8192L9.9971 10.6931L12.2632 11.8192C13.6751 12.5209 14.6902 13.8278 15.0207 15.3694L15.1734 16.0815C15.108 16.1392 15.0473 16.1907 14.9882 16.238L14.9874 16.2387C14.9353 16.2805 14.9312 16.2829 14.9234 16.2875C14.9131 16.2934 14.8963 16.3032 14.7541 16.4125C14.5931 16.5325 14.4825 16.6141 14.3752 16.6847L14.3593 16.6951L14.3436 16.7059C14.3137 16.7264 14.3023 16.733 14.2732 16.7499C14.2434 16.7673 14.195 16.7954 14.0892 16.8603L14.065 16.8748C13.9137 16.9659 13.818 17.0234 13.7223 17.0747C13.6694 17.1025 13.6271 17.1223 13.5519 17.1573C13.5117 17.1761 13.4621 17.1992 13.3964 17.2303C13.3456 17.2543 13.3029 17.2746 13.2659 17.2922C13.1629 17.3411 13.1037 17.3693 13.0356 17.3974C12.9672 17.4256 12.8983 17.4498 12.7842 17.4897C12.7506 17.5015 12.713 17.5147 12.6703 17.5298C12.5827 17.5607 12.5232 17.5824 12.4772 17.5991C12.4098 17.6236 12.3714 17.6376 12.3161 17.6547C12.2402 17.6773 12.1696 17.6945 12.0504 17.7234C12.0133 17.7324 11.9715 17.7425 11.9235 17.7543C11.8367 17.7743 11.7517 17.7962 11.6973 17.8102C11.6885 17.8125 11.6805 17.8145 11.6734 17.8163C11.6039 17.8342 11.5777 17.8402 11.5632 17.8431L11.9557 19.8042ZM11.9557 19.8042C11.7839 19.8384 11.6101 19.8618 11.4359 19.8852C11.4102 19.8887 11.3845 19.8921 11.3587 19.8956L14.6605 18.841C14.5601 18.8941 14.4581 18.9417 14.356 18.9893C14.3209 19.0057 14.2857 19.0221 14.2506 19.0387C14.219 19.0537 14.1874 19.0687 14.1558 19.0837C14.0376 19.14 13.9194 19.1962 13.7994 19.2458C13.6755 19.297 13.5426 19.3434 13.4188 19.3867C13.3907 19.3965 13.363 19.4062 13.336 19.4158C13.2939 19.4306 13.252 19.4458 13.21 19.461C13.1066 19.4985 13.003 19.5361 12.8968 19.5685C12.7627 19.6089 12.626 19.642 12.4894 19.675C12.4543 19.6835 12.4192 19.692 12.3841 19.7006C12.3229 19.7144 12.2617 19.7302 12.2004 19.7459C12.1188 19.7669 12.0373 19.7879 11.9557 19.8042ZM8.31438 5.58612C7.51232 6.45985 7.51234 7.802 8.31437 8.67566L9.99715 10.5087L11.6799 8.67566C12.5331 7.74633 12.4713 6.3013 11.5419 5.44812C10.6126 4.59499 9.16756 4.65675 8.31438 5.58612ZM8.31438 5.58612L6.84414 4.23646L8.31438 5.58612Z"
                                    fill={`${activeTab === "MyProfile" ? "#2395FF" : "#979797"}`}
                        ...
                        <h1 className={`flex justify-center gap-2 h-10 cursor-pointer w-1/2 ${activeTab === "MyBooking" ? "text-main border-b-4 border-b-main" : "text-abu"}`} onClick={() => handleTabClick("MyBooking")}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 20 20" fill="none">
                                <path
                                    d="M16.8243 3.33398H3.33268C2.41602 3.33398 1.67435 4.08398 1.67435 5.00065V8.33398C2.59102 8.33398 3.33268 9.08398 3.33268 10.0007C3.33268 10.9173 2.59102 11.6673 1.66602 11.6673V15.0007C1.66602 15.9173 2.41602 16.6673 3.33268 16.6673H16.666C17.5827 16.6673 18.3327 15.9173 18.3327 15.0007V5.00065C18.3327 4.08398 17.6577 3.33398 16.8243 3.33398ZM14.7743 11.084L7.39102 13.0507L6.00768 10.6507L6.78268 10.4423L7.83268 11.2673L9.82435 10.734L7.82435 7.26732L8.99102 6.95065L12.3327 10.0673L14.366 9.52565C14.5715 9.47131 14.7902 9.50038 14.9744 9.60651C15.1585 9.71265 15.2933 9.88726 15.3493 10.0923C15.4012 10.2999 15.3701 10.5195 15.2628 10.7047C15.1554 10.8898 14.9803 11.0258 14.7743 11.084Z"
                                    fill={`${activeTab === "MyBooking" ? "#2395FF" : "#979797"}`}
                    ...
                    {activeTab === "MyProfile" && (
                        <div className="w-full bg-white rounded-lg p-4 my-4 flex flex-col justify-between">
                            <div className="">
                                <h1 className="font-poppins text-little lg:text-sm mt-1 tracking-widest text-main font-medium">MY PROFILE</h1>
                                <h1 className="font-poppins text-lg lg:text-2xl text-black font-bold">My Profile</h1>
                            </div>
                            <div className="lg:flex lg:justify-between lg:gap-6">
                                <div className="mt-4 lg:w-1/2">
                                    <h1 className="font-poppins text-base text-black font-bold">Contact</h1>
                                    <div>
                                        <div className="border-b-4 border-b-gray-200 mt-4">
                                            <h1 className="pl-4 text-gray-400 font-poppins font-medium">Email</h1>
                                            <input type="email" className="w-full h-10 focus:outline-none p-4 font-poppins font-medium text-md text-abu" placeholder="Email" />
                                        </div>
                                        <div className="border-b-4 border-b-gray-200 mt-4">
                                ...
                                <div className="mt-4 lg:w-1/2">
                                    <h1 className="font-poppins text-base text-black font-bold">Biodata</h1>
                                    <div>
                                        <div className="border-b-4 border-b-gray-200 mt-4">
                                            <h1 className="pl-4 text-gray-400 font-poppins font-medium">Fullname</h1>
                                            <input type="text" className="w-full h-10 focus:outline-none p-4 font-poppins font-medium text-md text-abu" placeholder="Fullname" />
                                        </div>
                                        <div className="border-b-4 border-b-gray-200 mt-4">
                                            <h1 className="pl-4 text-gray-400 font-poppins font-medium">City</h1>
                                            <input type="text" className="w-full h-10 focus:outline-none p-4 font-poppins font-medium text-md text-abu" placeholder="City" />
                                        </div>
                                        <div className="border-b-4 border-b-gray-200 mt-4">
                                            <h1 className="pl-4 text-gray-400 font-poppins font-medium">Address</h1>
                                            <input type="text" className="w-full h-10 focus:outline-none p-4 font-poppins font-medium text-md text-abu" placeholder="Address" />
                                        </div>
                                        <div className="border-b-4 border-b-gray-200 mt-4">
                                            <h1 className="pl-4 text-gray-400 font-poppins font-medium">Post Code</h1>
                                            <input type="text" className="w-full h-10 focus:outline-none p-4 font-poppins font-medium text-md text-abu" placeholder="Post Code" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className=" mt-8 md:flex md:justify-end">
                                <div className="flex w-full md:w-60 h-10  bg-main items-center justify-center rounded-md hover:bg-blue-600 cursor-pointer shadow-lg shadow-blue-500/50">
                                    <h1 className="text-white text-sm font-medium">Save</h1>
                                </div>
                            </div>
                        </div>
                    )}
                    ...
                    {activeTab === "MyBooking" && (
                        <div>
                            <div className="w-full bg-white rounded-lg p-4 my-4 flex justify-between">
                                <div className="">
                                    <h1 className="font-poppins text-little lg:text-sm mt-1 tracking-widest text-main font-medium">MY BOOKING</h1>
                                    <h1 className="font-poppins text-lg lg:text-2xl text-black font-bold">My Booking</h1>
                                </div>
                    ...
                    <div className="flex md:hidden w-full h-14 my-4 border-gray-500 border-2 justify-center gap-2 items-center rounded-md  cursor-pointer">
                        ...
                        <h1 className="text-gray-500 text-lg font-medium">Setting</h1>
                    </div>
                </div>
            </div>
            <Footer />
