                ...
                <div className=" w-screen h-screen lg:w-1/2 relative">
                    <div className="container  px-16 md:px-32 md:mx-auto">
                        ...
                        <div className="hidden md:flex justify-center md:mt-2 lg:hidden">
                            <Image src={illustrasi2} width={300} />
                        </div>
                        <form className="mt-8 lg:mt-4" onSubmit={handleSubmit}>
                            ...
                            <div className="border-b-4 border-b-gray-200 mt-8">
                                <input type="text" className="w-full h-10 focus:outline-none p-4 font-poppins font-medium text-md text-abu" placeholder="Full Name" required />
                            </div>
                            <div className="border-b-4 border-b-gray-200 mt-8">
                            ...
                            <button type="submit" className="mt-8 w-full h-12 bg-main shadow-lg shadow-main/50 rounded-lg flex justify-center items-center hover:bg-blue-500 cursor-pointer">
