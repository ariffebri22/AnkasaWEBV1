                    ...
                    <div className="bg-slate-100 flex flex-col px-6 py-2 pt-4">
                        <div className="bg-white p-4 rounded-xl ">
                            <div className="hidden md:flex items-center gap-2">
                                ...
                                <h1 className="hidden md:block font-poppins font-medium text-gray-500">Garuda Indonesia</h1>
                            </div>
                            <div className="flex justify-between border-b-2 md:border-none  md:mt-4">
                                ...
                                <div className="flex flex-col md:flex-row-reverse w-20 md:w-full gap-1  md:justify-between md:items-center">
                                    ...
                                    <div className="flex flex-col items-center md:ml-4">
                                        ...
                                        <h1 className="text-xs font-poppins text-gray-400 mb-2 md:mb-0">(1 Transit)</h1>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="bg-slate-100 flex flex-col px-6 py-2 pt-4">
                        <div className="bg-white p-4 rounded-xl ">
                            <div className="hidden md:flex items-center gap-2">
                                ...
                                <h1 className="hidden md:block font-poppins font-medium text-gray-500">Air Asia</h1>
                            </div>
                            <div className="flex justify-between border-b-2 md:border-none  md:mt-4">
                                <div className="md:hidden flex items-center gap-4">
                                    <Image src={AirAsia} alt="AirAsia" className="" width={90} />
                                    <h1 className="hidden md:block">AirAsia</h1>
                                </div>
                                <div className="flex gap-3 items-center md:w-44 md:justify-between">
                                    <div>
                                        <h1 className="font-poppins font-semibold text-lg">IDN</h1>
                    ...
                    <div className="bg-slate-100 flex flex-col px-6 py-2 pt-4">
                        <div className="bg-white p-4 rounded-xl ">
                            <div className="hidden md:flex items-center gap-4">
                                ...
                                <h1 className="hidden md:block font-poppins font-medium text-gray-500">Lion Air</h1>
                            </div>
                            <div className="flex justify-between border-b-2 md:border-none  md:mt-4">
                                <div className="md:hidden flex items-center gap-2">
                                    <Image src={LionAir} alt="LionAIr" className="" width={90} />
